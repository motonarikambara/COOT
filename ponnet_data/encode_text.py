...
for clip_id in res["results"]:
    ...
    processed = input.video.filter("drawtext",x=100,y=50,text=text,fontfile="/usr/share/fonts/opentype/noto/NotoSansCJK-Regular.ttc",fontsize=25,fontcolor='#FFFFFF')
